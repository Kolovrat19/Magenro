<?php
class WebIntellect_NovaPoshta_Model_Carrier_NovaPoshta extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    {
        if (!$this->getConfigFlag('active')) { //актиыный ли метод доставки "Новая почта"
            return false;
        }


        $result = Mage::getModel('shipping/rate_result'); // Получаем доступные методы доставки

        $shippingPrice = 5; //Цена доставки
       $deliveryType = WebIntellect_NovaPoshta_Model_Api_Client::DELIVERY_TYPE_WAREHOUSE_WAREHOUSE; // Тип доставки "Склад-Склад"
       ...
       $method = Mage::getModel('shipping/rate_result_method');
        $method->setCarrier($this->_code)
            ...
            ->setMethodTitle('Доставка до склада Новой Пошты')
